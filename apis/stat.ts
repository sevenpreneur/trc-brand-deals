...
/** Batas aman: filter/sort di client tidak boleh bikin server ditembak tanpa henti. */
const NEEDS_ACTION_MAX_ROWS = 5000;
const NEEDS_ACTION_FETCH_PAGE_SIZE = 100;

/**
 * Semua brand deal sekaligus untuk tab Conversations yang filter & sort-nya
 * dikerjakan di client. Halaman pertama diambil dulu untuk tahu total, sisanya
 * ditarik paralel sampai cap.
 */
